...
private AdapterView.OnItemClickListener getOnItemClickListener() {
 ...
 public void AddItemsToList(int position, int index)
 {
	 try
	 {
		 ...
		 {
			 dm.getAppData().getGroceryList().get(position).addGroceryItem(new GroceryItem(ingridient, "1"));
  ...
  public void displayList() {
	    try {
	      listAdapter = new AddRecipeToGroceryListView(Add_to_grocerylist.this, R.layout.mylist_adapter, dm.getAppData().getGroceryList());
