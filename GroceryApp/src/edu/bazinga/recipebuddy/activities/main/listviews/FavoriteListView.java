...
public class FavoriteListView extends ArrayAdapter<String> {
  
  private DataManager dm;
  private Activity activity;
  
  public FavoriteListView(Activity activity, int textViewResourceId, ArrayList<String> objects) throws RecipeBuddyException {
