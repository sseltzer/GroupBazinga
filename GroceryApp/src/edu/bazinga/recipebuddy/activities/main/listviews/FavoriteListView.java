...
public class FavoriteListView extends BaseAdapter {

  private DataManager dm;
  private Activity activity;
  private LayoutInflater inflater;
  
  public FavoriteListView(Activity activity, LayoutInflater inflater) throws RecipeBuddyException {
  ...
  @Override
  public int getCount() {
    return dm.getAppData().getFavorites().size();
  }
