...
public class AddRecipeToGroceryListView extends ArrayAdapter<GroceryList> {
  private DataManager dm;
  private Activity activity;
 // private LinearLayout layout;
 
  public AddRecipeToGroceryListView(Activity activity, int textViewResourceId, ArrayList<GroceryList> objects) throws RecipeBuddyException {
